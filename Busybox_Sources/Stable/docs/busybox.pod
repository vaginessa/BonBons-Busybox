...
Currently available applets include:
	...
	[, [[, acpid, adjtimex, arp, arping, ash, awk, basename, bash,
	blkid, blockdev, bootchartd, brctl, bunzip2, bzcat, bzip2, cal, cat,
	catv, chattr, chgrp, chmod, chown, chpst, chrt, cksum, clear, cmp,
	comm, conspy, cp, cpio, crond, crontab, cttyhack, cut, date, dc, dd,
	depmod, df, diff, dirname, dmesg, dnsd, dnsdomainname, dos2unix, du,
	echo, egrep, env, envdir, ether-wake, expand, expr, fakeidentd,
	false, fatattr, fbset, fbsplash, fdisk, fgrep, find, findfs,
	flash_eraseall, flash_lock, flash_unlock, flashcp, fold, free, fsck,
	fsck.minix, fstrim, fsync, ftpd, ftpget, ftpput, fuser, getopt,
	getty, grep, groups, gunzip, gzip, halt, hd, head, hexdump,
	hostname, httpd, hush, hwclock, id, ifconfig, ifenslave, ifplugd,
	init, inotifyd, insmod, install, ionice, iostat, ipcalc, ipcrm,
	ipcs, kbd_mode, kill, killall, killall5, klogd, less, linuxrc, ln,
	logger, login, logread, losetup, ls, lsattr, lsmod, lsof, lspci,
	lsusb, lzop, lzopcat, makedevs, md5sum, mdev, mesg, microcom, mkdir,
	mkdosfs, mkfifo, mkfs.minix, mkfs.vfat, mknod, mkswap, mktemp,
	modinfo, modprobe, more, mount, mountpoint, mpstat, msh, mv, nameif,
	nanddump, nandwrite, nbd-client, nc, netstat, nice, nmeter, nohup,
	nslookup, ntpd, patch, pgrep, pidof, ping, ping6, pipe_progress,
	pivot_root, pkill, pmap, poweroff, printenv, printf, ps, pscan,
	pstree, pwd, pwdx, rdate, rdev, readahead, readlink, readprofile,
	realpath, reboot, renice, reset, resize, rev, rfkill, rm, rmdir,
	rmmod, route, rpm, rpm2cpio, rtcwake, run-parts, rx, script,
	scriptreplay, sed, seq, setserial, setsid, setuidgid, sh, sha1sum,
	sha256sum, sha3sum, sha512sum, showkey, slattach, sleep, smemcap,
	softlimit, sort, split, start-stop-daemon, stat, strings, stty, su,
	sulogin, sum, swapoff, swapon, switch_root, sync, sysctl, syslogd,
	tac, tail, tar, taskset, tee, telnet, test, tftp, tftpd, time,
	timeout, top, touch, tr, traceroute, traceroute6, true, truncate,
	tty, ttysize, tune2fs, uevent, umount, uname, unexpand, uniq,
	unix2dos, unlink, unlzop, unzip, uptime, usleep, uudecode, uuencode,
	vi, watch, watchdog, wc, wget, which, xargs, yes, zcat, zcip
